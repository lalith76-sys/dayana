...
<div class="card">
    <div class="card-header">
        ...
        <div class="card-tools">
            <a href="{{ route('sales-returns.create') }}" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> New Return</a>
        </div>
    </div>
    <div class="card-body">
    ...
    $(function() {
        $('#dataTable').DataTable({
            ...
            columns: [
                ...
                {data: 'date', name: 'date'},
                {data: 'customer.customer_name', name: 'customer.customer_name', defaultContent: '-'},
